        ...
        try {
            for (JTextField field : fields) {
                if (field != null && field.getText().trim().isEmpty()) {
                    AnimateMessage.showMessage("Please Fill all Fields", true, (MigLayout) getLayout(), this, 25, 15, 50, false);
                    return;
                }
            }
            ...
            if (!productService.isDigit(fields[0].getText().trim())) {
                AnimateMessage.showMessage("Id should only be number.", true, (MigLayout) getLayout(), this, 25, 15, 50, false);
                return;
            }
            ...
            AnimateMessage.showMessage("INVALID INPUT", true, (MigLayout) getLayout(), this, 25, 15, 50, false);
        }
    }
