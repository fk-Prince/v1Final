    ...
    private void displayUser() {
        JPanel panel = new JPanel(new MigLayout("fill,insets 0")) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2d.drawString(user.getUsername(), 80, (getHeight() + fm.getAscent()) / 2);
        ...
        button.addActionListener(_ -> {
            ...
            frame.dispose();
            if (cart != null){
                JFrame cartF = (JFrame) SwingUtilities.getWindowAncestor(cart);
                cartF.dispose();
            }
            if (sales != null){
                JFrame salesF = (JFrame) SwingUtilities.getWindowAncestor(sales);
                salesF.dispose();
            }
        ...
        if (panelName != null) {
            ...
            button.addActionListener(_ -> {
                ...
                if (label.equalsIgnoreCase("Sales")) {
                    sales = new SalesPanel(paymentRepository);
                }
            });
        }
        return button;
