...
public class PriceAdjustmentFrame extends JPanel implements ProductSelected, ResetPanel {
    ...
    private void inputs() {
        ...
        inputHolder.add(new JLabel("Markup / Markdown"), "pos 10% 62%");
        inputHolder.add(new JLabel("Percentage"), "pos 13% 65%");
        ...
        inputHolder.add(help, "pos 95% 14%");


        JLabel label = new JLabel("%");
        label.setFont(new Font("Arial", Font.BOLD, 15));
        inputHolder.add(label, "pos 92% 64%");
    ...
    private void markdown() {
        ...
        if (success) {
            AnimateMessage.showMessage("Price Updated", false, (MigLayout) getLayout(), this, 25, 10, 50, false);
            resetFields();
    ...
    private boolean valid() {
        ...
        if (inputPercentage.isEmpty()){
            AnimateMessage.showMessage("Fill the Field", true, (MigLayout) getLayout(), this, 25, 10, 50, false);
            return false;
        }
        if ( !isDigit(inputPercentage)) {
        ...
        if (markPercentage < 1) {
            AnimateMessage.showMessage("Please enter greater than 0", true, (MigLayout) getLayout(), this, 25, 10, 50, false);
            return false;
        }
        return true;
    }
